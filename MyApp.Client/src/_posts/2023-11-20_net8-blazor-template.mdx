...
import BlazorTemplate from "./components/BlazorTemplate"
...
<div className="text-center"><h3 id="blazor-template" className="text-4xl sm:text-5xl md:text-6xl tracking-tight font-extrabold text-gray-900">
...
<div className="not-prose relative bg-white dark:bg-black py-4">
    <div className="mx-auto max-w-md px-4 text-center sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8">
        <p className="mt-2 text-3xl font-extrabold tracking-tight text-gray-900 dark:text-gray-50 sm:text-4xl">Create a new Blazor Tailwind App</p>
